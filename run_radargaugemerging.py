import collect_gauge_radar_pairs
...
def main():
    ...
    collect_gauge_radar_pairs.run("201708121500", "201708121600", "gaugeradarpairs_201708121600.dat", "config")
    ...
    iterate_kalman_mfb.run("201708121600", "gaugeradarpairs_201708121600.dat", "mfb_state.dat", "config")
    ...
    collect_gauge_radar_pairs.run("201708121600", "201708121700", "gaugeradarpairs_201708121700.dat", "config")

    """ Using the previous MFB state, we can then run """

    iterate_kalman_mfb.run("201708121700", "gaugeradarpairs_201708121700.dat", "mfb_state.dat", "config", "mfb_state.dat")
